...
import { allApprovedTherapists, gettherapistAdditionalDetails, ListCreateTherapySession } from '../../Utils/constants'
            ...
            return(
                ...
                <div key={index}  className=" w-full max-w-xl bg-white border border-gray-200 rounded-lg shadow">
                    ...
                    <div className="flex flex-col items-center pb-10">
                        ...
                        <h5 className="mb-1 text-xl font-medium text-gray-900">{therapist.name}</h5>
                        <span className="mb-3 text-sm text-gray-500">{therapist.qualification}</span>
                        <p className='className="m-1 text-sm font-medium text-gray-900"'>Next Available at - </p>
                        <div className="flex mt-4 space-x-10 md:mt-6">
                            ...
                            <a  onClick={()=>navigate(client ? `/our-therapists/book-a-session/${therapist.therapist}/${therapist.name}`: "/login")}  className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300  cursor-pointer">Book a session</a>
                        </div>
                    </div>
