...
from .views import RegisterClientView,RetrieveClientView, RetrieveSubscriptionDetails,MoodJoural, LCTherapySessionAPI, RTherapySessiosTherapistAPI, RTherapySessiosClientAPI, RetrieveUpcomingSubscriptionClient, UpdateTherapySessionAPI, DeleteTherapySessionAPI, RetrieveCompletedSubscriptionClient
...
urlpatterns = [
    ...
    path('delete-therapy-session/<int:pk>/', DeleteTherapySessionAPI.as_view() ),
